            ...
            <div class="row">
                <div class="col-lg-11 mx-auto">
                    <section class="edica-404">
                        ...
                        <h5 class="edica-404-subtitle" data-aos="fade-up" data-aos-delay="100"></h5>
                        <p class="edics-404-text" data-aos="fade-up" data-aos-delay="200"></p>
                        <div class="entry-content">
                            <h1>Privacy Policy</h1>
                            <p>Valley (“us”, “we”, or “our”) operates the https://west.loc/ website (hereinafter referred to as the “Service”).</p>
                            ...
                            <h2>Definitions</h2>
                            <ul>
                                <li><strong>Service</strong>Service is the https://west.loc/ website operated by Valley</li>
                            ...
                            <h2>Use of Data</h2>
                            <p>Valley uses the collected data for various purposes:</p>
                            <ul>
                            ...
                            <p>If you are from the European Economic Area (EEA), Valley legal basis for collecting and using the personal information described in this Privacy Policy depends on the Personal Data we collect and the specific context in which we collect it.</p>
                            <p>Valley may process your Personal Data because:</p>
                            <ul>
                            ...
                            <p>Valley will retain your Personal Data only for as long as is necessary for the purposes set out in this Privacy Policy. We will retain and use your Personal Data to the extent necessary to comply with our legal obligations (for example, if we are required to retain your data to comply with applicable laws), resolve disputes and enforce our legal agreements and policies.</p>
                            <p>Valley will also retain Usage Data for internal analysis purposes. Usage Data is generally retained for a shorter period of time, except when this data is used to strengthen the security or to improve the functionality of our Service, or we are legally obligated to retain this data for longer periods.</p>
                            ...
                            <p>Valley will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
                            <h2>Disclosure of Data</h2>
                            <h3>Legal Requirements</h3>
                            <p>Valley may disclose your Personal Data in the good faith belief that such action is necessary to:</p>
                            <ul>
                                <li>To comply with a legal obligation</li>
                                <li>To protect and defend the rights or property of Valley</li>
                            ...
                            <p>If you are a resident of the European Economic Area (EEA), you have certain data protection rights. Valley aims to take reasonable steps to allow you to correct, amend, delete or limit the use of your Personal Data.</p>
                            ...
                            <ul>
                                ...
                                <li><strong>The right to withdraw consent.</strong> You also have the right to withdraw your consent at any time where Valley relied on your consent to process your personal information.</li>
                            </ul>
                            ...
                            <h2>Contact Us</h2>
                            <p>If you have any questions about this Privacy Policy, please contact us: <a href="mailto:info@Valley.net.ua">info@Valley.net.ua</a>.</p>
                        </div>
                        <a href="{{ route('main.index') }}" class="edica-404-link btn btn-warning" data-aos="fade-up" data-aos-delay="300">Go BAck</a>
                    </section>
                </div>
            </div>
        </div>
